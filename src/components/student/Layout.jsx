...
import {
    LayoutDashboard, LogOut, Clock, ClipboardList, Home as HomeIcon, Settings,
    Menu, X, GraduationCap, ChevronLeft, Search, UserCircle
} from 'lucide-react';
...
const StudentLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/student/routine', label: 'Routine', icon: Clock },
        { path: '/student/exam', label: 'Exam', icon: ClipboardList },
        { path: '/student/hostel', label: 'Hostel', icon: HomeIcon },
        ...
        <div className="min-h-screen bg-slate-50 flex font-sans">
            ...
            >
                ...
                <div className="p-6 border-b border-slate-800 flex items-center justify-between">
                    ...
                    {sidebarCollapsed && (
                        <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center font-bold mx-auto">
                            <GraduationCap size={20} />
                        </div>
                    )}
                </div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-xl">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-white truncate">
                                    {userProfile?.full_name || user?.email?.split('@')[0] || 'Student'}
                                </p>
